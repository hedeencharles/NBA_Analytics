...
Highcharts.getJSON(
  'https://bootcampgroupproject2.herokuapp.com/api/player_salary',
  function (data) {
...
Highcharts.getJSON('https://bootcampgroupproject2.herokuapp.com/api/states_winshare', function (data) {
  // console.log(data)
  // Instantiate the map
